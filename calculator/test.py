                ...
                ft.Container(
                    ...
                    content=ft.Column(
                        controls=[
                            ...
                            ft.Row(
                                controls=[
                                    MathButton(text="π", button_clicked=self.button_clicked),
                            ...
                            ft.Row(
                                controls=[
                                    MathButton(text="sin", button_clicked=self.button_clicked),
                            ...
                            ft.Row(
                                controls=[
                                    MathButton(text="x²", button_clicked=self.button_clicked),
                            ...
                            ft.Row(
                                controls=[
                                    MathButton(text="1/x", button_clicked=self.button_clicked),
